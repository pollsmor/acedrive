...
export function methodForFieldEquality (files, fieldTofetch, searchTerm) {
    ...
    for (let file of files) {
        ...
        if (file.isFolder) {
            let subfile_results = methodForFieldEquality(file.content, fieldTofetch, searchTerm)
...
export function methodForFieldStartsWith (files, fieldTofetch, searchTerm) {
    ...
    for (let file of files) {
        ...
        if (file.isFolder) {
            let subfile_results = methodForFieldStartsWith(file.content, fieldTofetch, searchTerm)
            results = results.concat(subfile_results)
        }
    }
