...
export default function QueryBuilder(props) {
  ...
  const operatorData = [
    ...
    op("Owned by", owner, setOwner, "owner:", "Returns files owned by a user."),
    op(
      "Created by",
      creator,
      setCreator,
    ...
    op("Shared by", from, setFrom, "from:", "Returns files shared by a user."),
    op(
  ...
  return (
    <Accordion defaultActiveKey="hello-world" className="my-2">
      <Accordion.Item>
        ...
        <Accordion.Body>
          <h6>
            For the fields below, a &quot;user&quot; is synonymous with their
            email.
          </h6>
          <Form onSubmit={builderHandler}>
            ...
            <Form.Group className="mb-1">
              ...
              >
                ...
                <option label="Files shared with anyone with the link">
                  anyone
                </option>
                <option label="Files shared with specific users">
                  individual
                </option>
                <option
                  label={`Files shared with anyone in the owner's domain`}
                >
                  domain
                </option>
              </Form.Control>
